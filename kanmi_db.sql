CREATE DATABASE  IF NOT EXISTS `kanmi_system` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `kanmi_system`;
-- MySQL dump 10.13  Distrib 8.0.20, for Win64 (x86_64)
--
-- Host: shutaura.prod.orion.nyti.ne.jp    Database: kanmi_system
-- ------------------------------------------------------
...
CREATE TABLE `kanmi_channels` (
  ...
  `parent` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `classification` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `nsfw` tinyint(1) NOT NULL DEFAULT '0',
  `last_message` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `watch_folder` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `role` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `role_write` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `role_manage` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `nice_name` text,
  `description` text,
...
CREATE TABLE `kanmi_records` (
  ...
  `attachment_proxy` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
...
CREATE TABLE `system_config` (
  ...
  `wss_key` varchar(128) DEFAULT NULL,
  `mq_user` varchar(128) DEFAULT NULL,
  `mq_pass` varchar(128) DEFAULT NULL,
  `mq_desu_return` varchar(128) DEFAULT NULL,
  `mq_twit_return` varchar(128) DEFAULT NULL,
  `mq_api_return` varchar(45) DEFAULT NULL,
  `mq_yt_return` varchar(128) DEFAULT NULL,
  `discord_user` int DEFAULT '1',
  `twitter_user` int DEFAULT '1',
  `pixiv_user` int DEFAULT '1',
  `youtube_user` int DEFAULT '1',
  `radio_folder` varchar(255) DEFAULT NULL,
  `publicweb_folder` varchar(45) DEFAULT NULL,
  `watch_folder_1` varchar(255) DEFAULT NULL,
  `watch_folder_2` varchar(255) DEFAULT NULL,
  `watch_folder_3` varchar(255) DEFAULT NULL,
  `ffmpeg_exec` varchar(128) DEFAULT 'ffmpeg',
  `ffmpeg_vcodec` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`system_id`),
  UNIQUE KEY `server_id_UNIQUE` (`system_id`),
...
--
-- Table structure for table `system_global`
--

DROP TABLE IF EXISTS `system_global`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `system_global` (
  `config_id` int NOT NULL,
  `mq_server` varchar(255) NOT NULL,
  `mq_desu_io_in` varchar(128) NOT NULL,
  `mq_desu_io_out` varchar(128) NOT NULL,
  `mq_twit_in` varchar(128) NOT NULL,
  `mq_twit_out` varchar(128) NOT NULL,
  `mq_pixiv_in` varchar(128) DEFAULT NULL,
  `mq_fileworker_in` varchar(128) DEFAULT NULL,
  `mq_yt_in` varchar(128) DEFAULT NULL,
  `mq_yt_out` varchar(128) DEFAULT NULL,
  `api_sausenao_key` varchar(128) DEFAULT NULL,
  `ffmpeg_scale` varchar(45) DEFAULT NULL,
  `ffmpeg_vbitrate` varchar(45) DEFAULT NULL,
  `ffmpeg_vcrf` varchar(45) DEFAULT NULL,
  `ffmpeg_acodec` varchar(45) DEFAULT NULL,
